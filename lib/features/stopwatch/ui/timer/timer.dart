...
class CircularCountDownTimerState extends State<CircularCountDownTimer>
  ...
  String get time {
    ...
    if (widget.isReverse && !widget.autoStart && !countDownController!.isStarted) {
      timeStamp = _getTime(Duration(seconds: widget.duration), Duration(seconds: widget.duration));
    } else {
      Duration? duration = (_controller!.duration!) * _controller!.value;
      timeStamp = _getTime(Duration(seconds: widget.duration), duration);
    }
  ...
  String _getTime(Duration init, Duration duration) {
    // For HH:mm:ss format
    ...
    // For mm:ss format
      ...
      if (duration != init && widget.isReverse) {
                  ...
                  children: <Widget>[
                    Positioned.fill(
                      child: Container(
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(width: 14, color: AppColors.backgroundPrimary),
                            boxShadow: const [
                              BoxShadow(
                                offset: Offset(0, 0),
                                blurRadius: 5,
                    ...
                    widget.isTimerTextShown
                        ? Align(
                            ...
                            child: Text(
                              _controller?.status == AnimationStatus.dismissed ? '00:00' : time,
                    ...
                    Align(
                      alignment: FractionalOffset.fromOffsetAndSize(
                          const Offset(5, 7), const Size(10, 10)),
                      child: const Text(
                        'Tap - Pause/Resume',
                        style: TextStyle(
                          fontSize: 14.0,
                    ...
                    Align(
                      alignment: FractionalOffset.fromOffsetAndSize(
                          const Offset(5, 7.8), const Size(10, 10)),
                      child: const Text(
                        'Double Tap - Restart',
                        style: TextStyle(
                          fontSize: 14.0,
...
class CountDownController {
  ...
  String getTime() {
    return _state._getTime(const Duration(seconds: 1000),
