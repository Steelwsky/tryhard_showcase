...
PACKAGE_LCOV_INFO_PATH=$PROJECT_ROOT_PATH/test_utils/coverage/lcov_tryhard.info
PACKAGE_TEST_REPORT_PATH=$PROJECT_ROOT_PATH/test_utils/test_reports/tryhard_test_report.json
